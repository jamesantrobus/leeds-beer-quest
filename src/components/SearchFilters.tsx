  ...
  return (
    <form className="flex justify-evenly space-x-3 ml-3 mr-3 mb-3">
      <div className="flex-1">
        <label htmlFor="category" className="block mb-1 text-xs font-light text-medium text-gray-900">
          Venue Type
        </label>
        <select
      ...
      <div className="flex-1">
        <label htmlFor="rating" className="block mb-1 text-xs font-light text-gray-900">
          Value Rating
        </label>
        <select
          value={searchParams.minimumValueRating}
          onChange={(e) => onRatingChange(e.target.value)}
          data-cy="value-rating-filter"
          id="rating"
          className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2"
        >
