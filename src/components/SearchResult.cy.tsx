...
describe('<SearchResult />', () => {
  ...
  it('renders the venue details', () => {
    cy.mount(<SearchResult name="Test Pub Name" description="Test Pub Description" rating={venueRating} onSelect={() => {}} />)
  ...
  it('allows a venue to be selected', () => {
    ...
    cy.mount(<SearchResult name="Test Pub Name" description="Test Pub Description" rating={venueRating} onSelect={onSelectSpy} />)
