...
describe('<SearchResultItem />', () => {
  const venueRating: VenueRating = { amenities: 1, atmosphere: 2, beer: 3, value: 4 }

  it('renders the venue details', () => {
    cy.mount(<SearchResultItem name="Test Pub Name" description="Test Pub Description" rating={venueRating} onSelect={() => {}} />)
  ...
  it('allows a venue to be selected', () => {
    ...
    cy.mount(<SearchResultItem name="Test Pub Name" description="Test Pub Description" rating={venueRating} onSelect={onSelectSpy} />)
